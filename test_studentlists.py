...
class TestStudentLists(TestCase):
    ...
    def test_is_enrolled_empty_class_list(self):
        test_class = ClassList('max_students')
    ...
    def test_index_of_student_not_present(self):
            test_class = ClassList('Harry')
            test_class.add_student('Jack')
            if self.assertIsNotNone(test_class.index_of_student('Jack')):
                self.assertEqual(2,test_class.index_of_student('Jack'))
